...
void uart1ClearFlash()
{
	...
	if (!SPI_FLASH_SectorIsClean(FLASH_ADR_UART1_DATA))
		SPI_FLASH_EraseSector(FLASH_ADR_UART1_DATA);
	if (!SPI_FLASH_SectorIsClean(FLASH_ADR_UART1_DATA + 0x10000))
		SPI_FLASH_EraseSector(FLASH_ADR_UART1_DATA + 0x10000);
	if (!SPI_FLASH_SectorIsClean(FLASH_ADR_UART1_DATA + 0x20000))
		SPI_FLASH_EraseSector(FLASH_ADR_UART1_DATA + 0x20000);
	if (!SPI_FLASH_SectorIsClean(FLASH_ADR_UART1_DATA + 0x30000))
		SPI_FLASH_EraseSector(FLASH_ADR_UART1_DATA + 0x30000);
}
